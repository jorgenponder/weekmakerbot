...
family = 'coronadokumenten' 
family_files['coronadokumenten'] = 'https://coronadokumenten.miraheze.org'
...
# family , you can use '*'
usernames['coronadokumenten']['coronadokumenten'] = 'Jorgenponder'
# usernames['coronadokumenten'] = 'Jorgenponder'
